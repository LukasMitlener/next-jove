    ...
    <div className="max-w-[1240px] px-6 py-16 mx-auto space-y-12">
      <article className="space-y-8 dark:bg-gray-800 dark:text-gray-50">
        <div className="space-y-6">
          <h1 className="text-4xl font-bold md:tracking-tight md:text-5xl">Jak se jezdí na kolečkových lyžích?</h1>
          <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-400">
            <div className="flex items-center md:space-x-2">
              ...
              <p className="text-sm">Josef Vejnar • 1. května, 2023</p>
            </div>
      ...
      <div>
        <div className="space-y-2">
          ...
          <ul className="ml-4 space-y-1 list-disc">
            ...
            <li>
              <Link rel="noopener noreferrer" href="/clanek4" className="hover:underline">Cesta k Baltu - zkouška ohněm</Link>
            </li>
          </ul>
        </div>
      </div>
