  ...
  return (
    <div className='max-w-[1240px] m-auto h-[80px] bg-transparent drop-shadow-lg px-6'>
      <div className='flex justify-between items-center w-full h-full'>
        ...
        <div className='hidden md:flex pr-4 text-lg font-semibold'>
          <ul className='hidden md:flex'>
            ...
            <li className='hover:text-main-blue'><Link to="testimonials" smooth={true} duration={500}>ŘEKLI O NÁS</Link></li>
        ...
        <div className='md:hidden mr-4' onClick={handleClick}>
            {!nav ? <MenuIcon className='w-5 text-main-blue' /> : <XIcon className='w-5 text-main-blue' />}
        </div>
      </div>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-main-light w-full px-8'}>
          ...
          <li className='border-b-2 border-zinc-100 w-full'><Link onClick={handleClose} to="testimonials" smooth={true} offset={-100} duration={500}>ŘEKLI O NÁS</Link></li>
