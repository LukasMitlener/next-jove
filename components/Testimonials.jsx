      ...
      <div className='max-w-[1240px] mx-auto px-6'>  
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:gap-16 lg:grid-cols-3">
          <div className="bg-white">
            ...
            >
              <p className="text-2xl font-bold">Standa Řezáč</p>
              <p className="mt-1 text-sm font-medium text-gray-500">
              dlouholetý reprezentant v dálkových bězích a trojnásobný vítěz Jizerské 50
              </p>
              <div>
              ...
              <p className="mt-4">
              Kolečkové lyže JOVE jsem vyhrál před několika lety na závodech na kol. lyžích ze  Špindlu na Špindlerovku, které firma JOVE pořádala.
              Jsou výborné na vyjížďky po všech cestách po Jizerkách a díky brzdám se na nich dá sjet téměř vše. Oblíbil si je můj mladej, který mi je zabavil a trénuje na nich. Doporučuji.
              </p>
          ...
          <div className="bg-white">
            <blockquote
              className="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
            >
              <p className="text-2xl font-bold text-gray-700">Zděnek Vejnar</p>
              <p className="mt-1 text-sm font-medium text-gray-500">
