...
const Testimonials = () => {
  return (
    <div name='testimonials' className="w-full mt-36">
      <div className='max-w-[1740px] mx-auto px-6'>  
        <div className="mt-12 grid grid-cols-1 gap-8 sm:gap-16 lg:grid-cols-3">
            <div
              className="bg-white flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
            >
              <p className="text-2xl font-bold text-gray-700">Blanka Paulů</p>
              <p className="mt-1 text-lg font-medium text-gray-500">
              nositelka stříbrné medaile z MS v běhu na 10km a olympijská medailistka ze štafety ze ZOH v Sarajevu
              </p>
              <div>
            ...
            <div
              className="bg-white flex flex-col justify-between rounded-lg p-12 text-center shadow-xl outline outline-main-blue outline-10"
            >
              ...
              <p className="mt-3">
              Kolečkové lyže JOVE jsem vyhrál před několika lety na závodech na kolečkových lyžích ze  Špindlu na Špindlerovku, které firma JOVE pořádala.
              Jsou výborné na vyjížďky po všech cestách po Jizerkách a díky brzdám se na nich dá sjet téměř vše. Oblíbil si je i můj mladej, který mi je zabavil a trénuje na nich. Doporučuji.
              </p>
              <div className="mt-8 flex justify-center gap-0.5 text-main-blue">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              className="bg-white flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
            >
              <p className="text-2xl font-bold text-gray-700">Zdeněk Vejnar</p>
              <p className="mt-1 text-lg font-medium text-gray-500">
