    ...
    <div name='testimonials' className="w-full mt-36">
      <div className='max-w-[1740px] mx-auto px-6'>  
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:gap-16 lg:grid-cols-3">
            ...
            <div
              className="flex flex-col justify-between rounded-lg p-12 text-center shadow-xl outline outline-main-blue outline-10"
            >
            ...
            <div
              className="flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
            >
