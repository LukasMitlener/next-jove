          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 sm:pt-20 pt-12'>
              <div className='bg-white rounded-lg shadow-xl flex flex-col justify-between'>
                  <div className='p-8'>
                      ...
                      <h3 className='text-2xl font-bold text-gray-700'>Český výrobek</h3>
              ...
              <div className='bg-white rounded-lg shadow-xl flex flex-col justify-between'>
                  <div className='p-8'>
                      ...
                      <h3 className='text-2xl font-bold text-gray-700'>Unikátní vlastnosti</h3>
              ...
              <div className='bg-white rounded-lg shadow-xl flex flex-col justify-between'>
                  <div className='p-8'>
                      ...
                      <h3 className='text-2xl font-bold text-gray-700'>Poměr cena výkon</h3>
