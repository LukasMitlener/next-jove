...
const Pricing = () => {
  return (
    <div name='cena' className='w-full mt-24'>
      <div className='max-w-[1240px] mx-auto px-12'>
        ...
        <div className='grid md:grid-cols-2'>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-xl relative'>
            ...
            <div>
              <p className='text-5xl font-bold py-4 flex'>8 999 Kč</p>
            </div>
            ...
            <div className='text-lg'>
                ...
                <p className='flex py-4'><XIcon className='w-8 mr-5 text-main-blue'  />Vylepšená kolečka.</p>
            </div>
          </div>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-xl relative'>
            ...
            <div>
              <p className='text-5xl font-bold py-4 flex'>11 999 Kč</p>
            </div>
